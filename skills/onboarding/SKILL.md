---
name: onboarding
description: Use when user mentions installing, configuring, or starting a project with developersDevelopers, or asks how to migrate from obra/superpowers. Surfaces the /bootstrap bootstrap command.
---
